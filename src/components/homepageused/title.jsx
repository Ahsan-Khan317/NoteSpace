...
return(
    <div className="relative flex flex-1  ">
        ...
        <span className={`absolute font-darkmode ${properties} not-sm:left-0 not-sm:top-56 text-9xl top-72 left-24 tracking-wide z-30  bg-linear-to-r from-red-700 to-blue-300 bg-clip-text text-transparent`}>Beautifully</span>
    </div>
)
}
